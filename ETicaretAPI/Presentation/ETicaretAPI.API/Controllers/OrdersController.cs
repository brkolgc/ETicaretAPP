...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionsConstants.Orders, ActionType = ActionType.Reading, Definition = "Get All Orders")]
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionsConstants.Orders, ActionType = ActionType.Reading, Definition = "Get Order By Id")]
        ...
        [HttpPost]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionsConstants.Orders, ActionType = ActionType.Writing, Definition = "Create Order")]
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionsConstants.Orders, ActionType = ActionType.Updating, Definition = "Complete Order")]
